<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="App1.admin" %>
       ...
       <!-- EDSION -->
          <center>         	
         	...
         	<div class="horizontal-scroll-contenedor">
          	 <img src="imgs/adm3.jpg" width="600" height="300"> 
       	  </div>
